...
const S = {
  ...
  searchWrap: { position: "relative", flex: 1, maxWidth: 320 } as React.CSSProperties,
  ...
  searchIcon: { position: "absolute", left: 10, top: "50%", transform: "translateY(-50%)", color: "#505070" } as React.CSSProperties,
  ...
  modal: { position: "fixed" as const, inset: 0, background: "rgba(0,0,0,0.7)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 },
  modalBox: { background: "#0D0D1F", border: "1px solid #1C1C35", borderRadius: 16, padding: 28, width: 480, maxHeight: "85vh", overflowY: "auto" as const },
...
export default function InventoryPage() {
  ...
  return (
    <div style={S.page}>
      <div style={S.header}>
        <div>
          <h1 style={S.title}>Inventory & Stock</h1>
          <p style={S.subtitle}>Manage products, categories, and stock levels</p>
        </div>
