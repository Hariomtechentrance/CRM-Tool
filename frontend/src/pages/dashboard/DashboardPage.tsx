...
const card: React.CSSProperties = { background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 14, overflow: "hidden" };
  ...
  return (
    <div className="page-pad" style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: 1400 }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
        ...
        <span style={{ fontSize: 12, fontWeight: 600, color: "var(--text-faint)", background: "var(--bg-hover)", border: "1px solid var(--border)", padding: "6px 14px", borderRadius: 8 }}>
